...
def DoSimulation1(n, t, r, a, beta, price, var, alpha, eps_BC, X, A, actions, order_price_rational, Z_current_rational,
    ...
    print("----Running Combined Simulation 1----")
    price_list_Rational = [price]
    X_opinion_rational = [X.mean()]
    ...
    for round in range(t):
        ...
        X_opinion_rational.append(X.mean())
    ...
    print("price_list_Rational + X_opinion_rational")
    print(price_list_Rational)
    print(X_opinion_rational)
...
def initialization():
    ...
    DoSimulation1(n, t, r, a, beta, price, var, alpha, eps_BC, X, A, actions, order_price_rational, Z_current_rational,
                  max_Z_delta, orderPconstant, add_agents_sequence)
