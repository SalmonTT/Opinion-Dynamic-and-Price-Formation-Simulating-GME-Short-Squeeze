...
def DoSimulation2(n, t, r, a, beta, price, var, alpha, eps_BC, X, A, actions, order_price_rational, Z_current_rational,
                  max_current_Z, max_Z_delta, orderPconstant, add_agents_sequence):
...
def initilization():
    ...
    DoSimulation2(n, t, r, a, beta, price, var, alpha, eps_BC, X, A, actions, order_price_rational, Z_current_rational,
                  max_current_Z, max_Z_delta, orderPconstant, add_agents_sequence)
