...
def getOrderPriceSimple(Z_delta, r, p, orderPconstant):
    ...
    for i in range(len(Z_delta)):
        orderPrice[i] = (1 + r + orderPconstant) * p
    return orderPrice
...
def DoSimulation():
    ...
    Z_delta_irrational = []
    max_Z_delta = 20
    order_price_irrational = []  # prices of current order for each agent
    irrational_orderprice_alpha = 0.05
    GME_price_array = [14927612
                    ,7060665
                    ,144501736
                    ,93717410
                    ,46866358
    ...
    add_agents_sequence = [x/10000000 for x in GME_price_array]
    ...
    for round in range(t):
        ...
        order_price_irrational = getOrderPriceSimple(Z_delta_irrational, r, price, irrational_orderprice_alpha)
        print("orderprices")
        print(len(order_price_rational))
        print(len(order_price_irrational))
